...
<main>
    <!-- ======= Hero Section ======= -->
    <section class="about-hero-section text-center">
        <div class="container">
            <h1 class="display-4">Welcome to BPL Bus</h1>
            <p class="lead mt-3">We are more than just a bus ticket booking platform; we are your dedicated partners in travel, committed to making every journey safe, comfortable, and memorable.</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <!-- Recommended: Replace this placeholder with a high-quality image of one of your buses -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3 d-flex align-items-stretch mb-4">
                    <div class="value-card">
                        ...
                        <p>We are here for you, around the clock. Our goal is to be your travel partner, providing a seamless booking experience and responsive support for any query you might have.</p>
                    </div>
                </div>
                <div class="col-lg-3 d-flex align-items-stretch mb-4">
                    <div class="value-card">
