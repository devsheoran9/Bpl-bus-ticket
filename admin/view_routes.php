...
try {
    $routes_list = $_conn_db->query(
        "SELECT r.route_id, r.route_name, r.starting_point, r.ending_point, r.status, r.is_popular, r.is_chartered, b.bus_name, b.registration_number, b.bus_type
         FROM routes r 
...
<head>
    ...
    <style>
        ...
        .route-grid {
            ...
            /* Min-width 350px, bit smaller for compactness */
            gap: 1.5rem;
        ...
        .route-card.status-Upcoming {
            border-left-color: #feca57;
        }

        .route-card-body {
            padding: 1rem 1.25rem;
            /* Optimized padding, slightly less top/bottom */
            flex-grow: 1;
        }
        ...
        .route-status-badge.bg-success-subtle {
            background-color: #d1e7dd !important;
            color: #0f5132 !important;
            border: 1px solid #badbcc;
        }

        .route-status-badge.bg-secondary-subtle {
        ...
        .route-card-footer {
            ...
            display: flex;
            justify-content: space-between;
            /* Space out action buttons and toggle */
            align-items: center;
            gap: 0.75rem;
            /* Gap between button group and toggle */
            flex-wrap: wrap;
        ...
        .charter-dates-info {
            ...
            /* Light separator for this section */
        }
        ...
        .schedule-timeline-icon i {
            color: white;
            /* Changed to white for consistency with other icon-styles */
        }
        ...
        /* Re-applying these specific colors */
        .icon-stop {
            background-color: #6c757d;
        }
            ...
            <div class="container-fluid">
                ...
                <?php if (empty($routes_list)): ?>
                    <div class="alert alert-info text-center">
                        ...
                        <p>Why not <a href="add_route.php" class="alert-link">add one now</a> to get started?</p>
                    </div>
                <?php else: ?>
                        ...
                        <?php foreach ($routes_list as $route): ?>
                            <div class="route-card status-<?php echo htmlspecialchars($route['status']); ?>">
                                <div class="route-card-body">
                                    ...
                                    <i class="fas fa-bus fa-fw"></i><span><?php echo htmlspecialchars($route['bus_name']); ?> (<?php echo htmlspecialchars($route['registration_number']); ?>)</span>
                                        ...
                                        <i class="fas fa-shuttle-van"></i><span><?php echo htmlspecialchars($route['bus_type']); ?></span>
                                                    ...
                                                    <div class="schedule-day-block">
                                                        ...
                                                        <div class="schedule-timeline">
                                                            ...
                                                            try {
                                                                ...
                                                                echo "<p class='text-danger'>Error calculating schedule.</p>";
                                                            }
                                                            ?>
                                                        </div>
                                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.check-charter-status-btn').on('click', function() {
                ...
                if (!selectedDate) {
                    Swal.fire('Date Needed', 'Please select a date first.', 'info');
                    return;
                }
