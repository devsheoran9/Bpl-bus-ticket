...
<head>
    ...
    <style>
        ...
        .days-selector .form-check-input:checked+.form-check-label {
...
<body>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="function/backend/route_actions.php" method="POST" class="data-form">
                            ...
                            <div class="row g-1 bg-light rounded mb-4">
                                ...
                                <div class="col-lg-4 col-6 mb-3"><label class="form-label">Assign Bus</label><select class="form-select" name="bus_id" required>
                                        <option value="">-- Select --</option><?php foreach ($buses as $bus): ?><option value="<?php echo $bus['bus_id']; ?>" <?php echo (isset($route_to_edit['bus_id']) && $route_to_edit['bus_id'] == $bus['bus_id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($bus['bus_name']); ?></option><?php endforeach; ?>
                                    </select></div>
                                <div class="col-lg-4 col-6 mb-3"><label class="form-label">Status</label><select class="form-select" name="status">
                                        <option value="Active" <?php echo (isset($route_to_edit['status']) && $route_to_edit['status'] == 'Active') ? 'selected' : ''; ?>>Active</option>
                                        <option value="Inactive" <?php echo (isset($route_to_edit['status']) && $route_to_edit['status'] == 'Inactive') ? 'selected' : ''; ?>>Inactive</option>
                                    </select></div>
                            </div>

                            <h5>2. Select Operating Days & Departure Times</h5>
                            <?php $days = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'];
                            $selected_days = array_keys($schedules_to_edit); ?>
                            ...
                            <div class="mb-3">
                                <h6>Starting Point</h6><input type="text" class="form-control" name="starting_point" value="<?php echo htmlspecialchars($route_to_edit['starting_point'] ?? ''); ?>" required>
                            </div>
                                        ...
                                        <div class="stop-item">
                                            <div class="stop-item-content">
                                                <div class="stop-header">
                                                    <h6>Intermediate Stop</h6><button type="button" class="btn btn-sm btn-outline-danger remove-stop-btn">&times; Remove</button>
                                                </div>
                                                <div class="row">
    ...
    <div id="stop-row-template" style="display: none;">
        <div class="stop-item">
            <div class="stop-item-content">
                <div class="stop-header">
                    <h6>New Intermediate Stop</h6><button type="button" class="btn btn-sm btn-outline-danger remove-stop-btn">&times; Remove</button>
                </div>
                <div class="row">
