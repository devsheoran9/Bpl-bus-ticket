...
try {
    ...
    // It's better to log errors than to die on a production site.
    error_log("Database Error: " . $e->getMessage());
    $bookings = []; // Ensure bookings is an array to prevent errors later.
...
<head>
    ...
    <style>
        ...
        /* Ensure the table header is clean and aligned */
        #bookings-table thead th {
            text-align: left;
        }
        #bookings-table thead th.text-end {
            text-align: right;
        }
    </style>
</head>
        ...
        <div class="container-fluid">
            ...
            <div class="row g-4 mb-4">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card summary-card card-total-cash h-100">
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                     <div class="card summary-card card-cash-collected h-100">
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="card summary-card card-cash-due h-100">
                        <div class="card-body">
            ...
            <!-- Bookings List Data Table (Now visible on ALL screens) -->
            <div class="card">
                <div class="card-header">
                    <h5>My Booking History</h5>
                </div>
                <div class="card-body">
                    <table id="bookings-table" class="table table-hover dt-responsive nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>Ticket #</th>
                                <th>Travel Date</th>
                            ...
                            <?php foreach ($bookings as $booking): ?>
                                <tr class="<?php echo ($booking['payment_method'] === 'CASH' && !$booking['is_collected']) ? 'table-warning' : ''; ?>">
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <span class="text-danger fw-bold"><i class="fas fa-hourglass-half me-1"></i> Pending</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
...
<!-- DataTables Core and Extensions JS -->
...
$(document).ready(function() {
    ...
    $('#bookings-table').DataTable({
        ...
        dom: 'Bfrtip',
        buttons: [
            { extend: 'copyHtml5', title: 'My Cash Report - <?php echo addslashes($employee_name); ?>' },
            { extend: 'csvHtml5', title: 'My Cash Report - <?php echo addslashes($employee_name); ?>', filename: 'Cash-Report-<?php echo str_replace(' ', '-', $employee_name); ?>-<?php echo date('Y-m-d'); ?>' },
            { extend: 'excelHtml5', title: 'My Cash Report - <?php echo addslashes($employee_name); ?>', filename: 'Cash-Report-<?php echo str_replace(' ', '-', $employee_name); ?>-<?php echo date('Y-m-d'); ?>' },
            { extend: 'pdfHtml5', title: 'My Cash Report - <?php echo addslashes($employee_name); ?>', filename: 'Cash-Report-<?php echo str_replace(' ', '-', $employee_name); ?>-<?php echo date('Y-m-d'); ?>' },
            { extend: 'print', title: 'My Cash Report - <?php echo addslashes($employee_name); ?>', messageTop: 'A summary of cash and online bookings.' }
        ],
        pageLength: 10,
        ...
        columnDefs: [
            ...
            { responsivePriority: 2, targets: 2 }, // Fare
            { responsivePriority: 3, targets: 3 }, // Collection Status
            { responsivePriority: 4, targets: 1 }  // Travel Date
            // Other columns will have lower priority and collapse sooner
        ]
    });
});
</script>
