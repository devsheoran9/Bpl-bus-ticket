...
<head>
    ...
    <!-- Using the exact same CSS as generate_ticket.php -->
    <style>
        :root {
...
<body>
    <div class="ticket-viewport">
        <div id="ticket-wrapper">
            <!-- Using the exact same HTML structure as generate_ticket.php -->
            <div class="bus-ticket">
                ...
                <div class="stub-panel">
                    ...
                    <div id="qrcode"></div>
                    <div style="text-align:center;"><div class="label" style="font-size:11px;">Date</div><div class="value" style="font-size:14px;"><?php echo $actual_departure_datetime->format('D, d M Y'); ?></div></div>
                    <div style="text-align:center;"><div class="label" style="font-size:11px;">Total Fare</div><div class="value" style="font-size:18px;">₹<?php echo number_format($booking_details['total_fare'], 2); ?></div></div>
